...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_UID           = "uid";       // Firebase UID
    ...
    private static final String COL_USER_ID       = "user_id";   // links to uid
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_FAVOURITES + " ("
                + COL_PROPERTY_ID   + " TEXT PRIMARY KEY, "
    ...
    public void addFavourite(String userId, String propertyId,
                             String name, String price, String location) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues cv = new ContentValues();
    ...
    public void removeFavourite(String propertyId) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public boolean isFavourite(String propertyId) {
        SQLiteDatabase db = getReadableDatabase();
